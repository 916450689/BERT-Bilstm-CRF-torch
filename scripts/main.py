...
def main():
    ...
    model = BERT_BiLSTM_CRF(tagset_size,
                            ...
                            device).to(device)
    #summary(model=model, input_data=(5, 768))
    ...
    for epoch in range(start_epoch, config.epochs+1):
        ...
        if valid_estimator[2] < best_score:
            ...
            torch.save({"epoch": epoch,
                       ...
                       os.path.join(config.target_dir, "RoBERTa_best_{:.4f}_{:.4f}.pth.tar".format(best_score,valid_loss)))
        ...
        torch.save({"epoch": epoch,
                    ...
                    "train_losses": train_losses,
                    "valid_losses": valid_losses},
                   os.path.join(config.target_dir, "RoBERTa_NER_{}_{:.4f}.pth.tar".format(epoch, valid_loss)))
        '''
